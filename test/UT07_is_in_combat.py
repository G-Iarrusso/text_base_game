...
from game.objects.combat import is_in_combat  # noqa: E402
...
test_room.print_room()
assert is_in_combat(test_player, room_dragons), "Player should be in combat"
...
assert not is_in_combat(
    test_player, room_dragons), "Player should not be in combat"
