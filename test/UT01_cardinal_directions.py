...
), "UT1_cardinal_directions: FAILED - Test fails on moving north"
...
control_room = Room(3, 3, player=control_player)
assert test_room.print_room() == control_room.print_room(
), "UT1_cardinal_directions: FAILED - Test fails on moving east"
...
control_room = Room(3, 3, player=control_player)
assert test_room.print_room() == control_room.print_room(
), "UT1_cardinal_directions: FAILED - Test fails on moving south"
...
control_room = Room(3, 3, player=control_player)
assert test_room.print_room() == control_room.print_room(
), "UT1_cardinal_directions: FAILED - Test fails on moving west"
