def print_player(player):
        ...
        """
        print("Starting health: " + str(player.starting_health) + " Current Health: " + str(player.current_health))
...
def print_hazard(hazard):
        ...
        Hazards info
        """
        print("X: " + str(hazard.x + 1) + " Y: " + str(hazard.y + 1) + " Tile type: " + hazard.tile)
...
def print_dragon(dragon):
        ...
        print("Species: " + dragon.species + ", Current health: " + str(dragon.current_health) + ", Total health: " + str(dragon.starting_health))
